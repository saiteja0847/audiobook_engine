...
def update_project_chunks(project_dir: Path):
    ...
    for chunk in chunks:
        ...
        if 'emotion_prompt' not in chunk or chunk['emotion_prompt'] is None:
            chunk['emotion_prompt'] = chunk['metadata']['emotion']
            updated_count += 1
...
def main():
    ...
    print("\n" + "=" * 70)
    print("Updating All Chunks to have emotion_prompt")
    print("=" * 70)
